...
class ChatModule extends CWebModule {
	...
	private $_versionDate = "21/03/2018";
	private $_keywords = "chat, rocketchat,module,opensource,CO,communecter";
	private $_description = "Chat module for CO";
	private $_pageTitle = "Chat module & CO Systems";
