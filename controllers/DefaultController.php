...
class DefaultController extends CommunecterController {
  ...
  public function actionTest() {
    ...
    Yii::import('chat.vendor.fab1en.rocket-chat-rest-client.src.RocketChatClient', true);
    Yii::import('chat.vendor.fab1en.rocket-chat-rest-client.src.RocketChatUser', true);
    Yii::import('chat.vendor.fab1en.rocket-chat-rest-client.src.RocketChatChannel', true);
    Yii::import('chat.vendor.fab1en.rocket-chat-rest-client.src.RocketChatGroup', true);
